                                ...
                                <div class="row align-items-center gx-5">
                                    <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                        <div class="bg-light p-4 rounded-4">
                                            <div class="text-primary fw-bolder mb-2">2/2023 - Present</div>
                                            <div class="small fw-bolder">Teacher assistant</div>
                                            <div class="small text-muted">Damascus university</div>
                                            <div class="small text-muted">Damascus ,Syria </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                        <div>• Supervised students in the classroom and helped them
                                            with their work.<br>
                                            • Taught the course "Intelligent Search Algorithms" for
                                            fourth-year computer science students <br>
                                            • Supervised of third-year students’s projects in
                                            computer science <br>
                                            • Provided guidance and support to students as they
                                            developed their projects.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
